...
<head>
    ...
    <body class="sb-nav-fixed">
        ...
        var myLineChart_2022 = new Chart(ctx_2023, {
          type: 'bar',
          data: {
            labels: ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"],
            datasets: [{
        ...
        var empresas_mais_treinadas = new Chart(empresas, {
          type: "horizontalBar",
          data: {
          labels: ["<c:out value='${mais_treinadas_1}' />", "<c:out value='${mais_treinadas_2}' />", "<c:out value='${mais_treinadas_3}' />", "<c:out value='${mais_treinadas_4}' />", "<c:out value='${mais_treinadas_5}' />"],
          datasets: [{
            backgroundColor: ["red", "green","blue","orange","brown"],
            data: [<c:out value='${mais_treinadas_1_qtd}' />, <c:out value='${mais_treinadas_2_qtd}' />, <c:out value='${mais_treinadas_3_qtd}' />, <c:out value='${mais_treinadas_4_qtd}' />, <c:out value='${mais_treinadas_5_qtd}' />]
          }]
        },
          options: {
